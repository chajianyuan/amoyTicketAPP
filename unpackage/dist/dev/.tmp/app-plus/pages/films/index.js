...
var _bus = _interopRequireDefault(__webpack_require__(/*! ../../utils/bus.js */ "E:\\课设\\大三第二学期\\amoyTicketApp\\utils\\bus.js"));
...
var _session = __webpack_require__(/*! ../../api/session.js */ "E:\\课设\\大三第二学期\\amoyTicketApp\\api\\session.js");function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _toConsumableArray(arr) {return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread();}function _nonIterableSpread() {throw new TypeError("Invalid attempt to spread non-iterable instance");}function _iterableToArray(iter) {if (Symbol.iterator in Object(iter) || Object.prototype.toString.call(iter) === "[object Arguments]") return Array.from(iter);}function _arrayWithoutHoles(arr) {if (Array.isArray(arr)) {for (var i = 0, arr2 = new Array(arr.length); i < arr.length; i++) {arr2[i] = arr[i];}return arr2;}}var uniSegmentedControl = function uniSegmentedControl() {return __webpack_require__.e(/*! import() | components/uni-segmented-control/uni-segmented-control */ "components/uni-segmented-control/uni-segmented-control").then(__webpack_require__.bind(null, /*! @/components/uni-segmented-control/uni-segmented-control.vue */ "E:\\课设\\大三第二学期\\amoyTicketApp\\components\\uni-segmented-control\\uni-segmented-control.vue"));};var _default =
{
  ...
  onShow: function onShow() {
    console.log('333333333', " at pages\\films\\index.vue:148");
    // bus.$on('city', value => {
    // 	this.city = value;
    // });
    // console.log('sssss');
    ...
    if (uni.getStorageSync('zhuangtai')) {
      ...
      console.log('this.current1' + JSON.stringify(this.current1), " at pages\\films\\index.vue:164");
    }
    this.getFilms();
  ...
  methods: {
    //获得电影信息
    getFilms: function getFilms() {var _this = this;
      this.hotMovies = [];
      this.commingMovies = [];
      (0, _film.findAllFilms)().then(
      function (res) {
        if (res.errno === 0) {
          res.data = _toConsumableArray(new Set(res.data));
          console.log('res.data' + JSON.stringify(res.data), " at pages\\films\\index.vue:179");
          res.data.forEach(function (item) {
            (0, _film.findFilmById)({ id: item }).then(
            function (res1) {
              if (res1.errno === 0) {
                console.log('res1' + JSON.stringify(res1), " at pages\\films\\index.vue:184");
                ...
                if (res1.data.status === 0) {
                  _this.hotMovies.push(res1.data);
                  _this.hotMovies = _toConsumableArray(new Set(_this.hotMovies));
                  console.log('this.hotMovies' + JSON.stringify(_this.hotMovies), " at pages\\films\\index.vue:194");
                }
                if (res1.data.status === 1) {
                  _this.commingMovies.push(res1.data);
                  console.log('this.commingMovies' + JSON.stringify(_this.commingMovies), " at pages\\films\\index.vue:198");
                }
              }
            },
            function (err1) {
              console.log('err1' + JSON.stringify(err1), " at pages\\films\\index.vue:203");
            });
      ...
      function (err) {
        console.log('err' + JSON.stringify(err), " at pages\\films\\index.vue:210");
      });

    },
    tabSelect: function tabSelect(e) {
      console.log('e11111' + JSON.stringify(e), " at pages\\films\\index.vue:215");
    },
    onClickItem: function onClickItem(e) {
      console.log('e' + JSON.stringify(e), " at pages\\films\\index.vue:218");
      this.current = e;
      this.findCinemaByCity();
      // this.getFilms();
    },
    onClickItem1: function onClickItem1(e) {
      console.log('e' + JSON.stringify(e), " at pages\\films\\index.vue:224");
      this.current1 = e;
      this.getFilms();
    },
    ...
    gofindCinema: function gofindCinema(data) {
      uni.navigateTo({
        url: './findCinema?id=' + data._id + '&filmName=' + data.filmName + '&cityId=' + this.cityId });

    },
    goFilmDetail: function goFilmDetail(data) {
      console.log('data' + JSON.stringify(data), " at pages\\films\\index.vue:239");
      uni.navigateTo({
        url: '../films/filmDetail?filmId=' + data._id });

    },
    findCinemaByCity: function findCinemaByCity() {var _this2 = this;
      this.cinemas = [];
      console.log('fffffffffffffffffffffffffffffffffffffffffffffffff', " at pages\\films\\index.vue:246");
      (0, _cinema.findCinemaByCityId)({ cityId: this.cityId }).then(
      function (res) {
        console.log('res' + JSON.stringify(res), " at pages\\films\\index.vue:249");
        if (res.errno === 0) {
          // this.cinemas = res.data;
          res.data.forEach(function (item) {
            console.log('item', JSON.stringify(item), " at pages\\films\\index.vue:253");
            (0, _session.findSessionByCieamId)({ cinemaId: item._id }).then(
            function (res1) {
              // console.log('res1', JSON.stringify(res1));
              if (res1.errno === 0 && res1.data.length !== 0) {
                var prices = [];
                res1.data.forEach(function (item2) {
              ...
              var ids = [];
              console.log('ids', JSON.stringify(ids), " at pages\\films\\index.vue:268");
              console.log('ids.indexOf(item._id)=========', JSON.stringify(ids.indexOf(item._id) === -1), " at pages\\films\\index.vue:269");
              if (ids.indexOf(item._id) === -1) {
                ids.push(item._id);
                _this2.cinemas.push(item);
                _this2.cinemas = _toConsumableArray(new Set(_this2.cinemas));
              }
            },
            function (err1) {
              console.log('err1', JSON.stringify(err1), " at pages\\films\\index.vue:277");
            });
      ...
      function (err) {
        console.log('err' + JSON.stringify(err), " at pages\\films\\index.vue:284");
      });

    },
    inputFocus: function inputFocus() {
      console.log('wwwww', " at pages\\films\\index.vue:289");
      uni.navigateTo({
        url: '../films/searchFilmCinema' });

    },
    goMovieSession: function goMovieSession(data) {
      console.log('data' + JSON.stringify(data), " at pages\\films\\index.vue:295");
      uni.navigateTo({
