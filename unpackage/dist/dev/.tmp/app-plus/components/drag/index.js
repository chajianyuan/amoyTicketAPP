...
var _default =
{
  ...
  onReady: function onReady() {var _this = this;
    _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var width1, width2, view1;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
              ...
              function (data) {
                console.log('得到节点信息' + JSON.stringify(data), " at components\\drag\\index.vue:33");
                console.log('节点的宽为' + data.width, " at components\\drag\\index.vue:34");
                width1 = data.width;
              }).
  ...
  methods: {
    mousedownFn: function mousedownFn(e) {
      console.log('eeeeeeee' + JSON.stringify(e), " at components\\drag\\index.vue:62");
...
;(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
    'components/drag/index-create-component',
    {
        'components/drag/index-create-component':(function(module, exports, __webpack_require__){
            __webpack_require__('./node_modules/@dcloudio/uni-app-plus/dist/index.js')['createComponent'](__webpack_require__("E:\\课设\\大三第二学期\\amoyTicketApp\\components\\drag\\index.vue"))
        })
    },
    [['components/drag/index-create-component']]
]);                
