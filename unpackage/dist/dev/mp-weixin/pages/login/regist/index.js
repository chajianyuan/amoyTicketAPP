...
//
//
var _default = { data: function data() {return { showPwd: false, password: '', isPwd: true, showRePwd: false, rePassword: '', isRePwd: true, telephone: '' };}, methods: { changeShowPwd: function changeShowPwd() {this.showPwd = !this.showPwd;}, changeShowRePwd: function changeShowRePwd() {this.showRePwd = !this.showRePwd;}, userRegist: function userRegist() {console.log('1111' + JSON.stringify(this.password));console.log('1111' + JSON.stringify(this.rePassword));if (this.password === this.rePassword) {console.log('两次密码一致');var postData = { telephone: this.telephone, password: this.password, roles: 1 };(0, _user.regist)(postData).then(function (res) {console.log('res' + JSON.stringify(res));
          if (res.errno === 0) {
            uni.navigateBack({
              delta: 1 });
...
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/login/regist/index.js.map